...
Namespace DX12GameProgramming
    ...
    Friend Class FrameResource
        ...
        Public Sub New(ByVal device As Device, ByVal passCount As Integer, ByVal objectCount As Integer, ByVal materialCount As Integer, ByVal waveVertCount As Integer)
